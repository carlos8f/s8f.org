...
- One source text was [Jonathan Livingston Seagull](https://en.wikipedia.org/wiki/Jonathan_Livingston_Seagull) (by Richard Bach) and the other was something unknown, referring to "canisters", a "map", and a "window".
...
12th anniversary retrospective in `#bot18` Discord chat:
