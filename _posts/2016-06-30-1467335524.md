...
[![GitPitch](https://gitpitch.com/assets/badge.svg)](https://gitpitch.com/DeviaVir/zenbot/master?t=moon)

> “To follow the path, look to the master, follow the master, walk with the master, see through the master, become the master.”
> – Zen Proverb

- New to Zenbot? Watch the slideshow: [Introducing Zenbot 3](https://gitpitch.com/DeviaVir/zenbot/master?t=moon)
...
- Want to contribute to Zenbot? Read the [contributions guide](https://github.com/DeviaVir/zenbot/blob/master/CONTRIBUTING.md)
...
![screenshot](https://raw.githubusercontent.com/DeviaVir/zenbot/master/assets/zenbot_web_logs.png)
...
- **3.3.0**
    ...
    - Added [contributions guide](https://github.com/DeviaVir/zenbot/blob/master/CONTRIBUTING.md).
    - Updated slideshow: [Introducing Zenbot 3](https://gitpitch.com/DeviaVir/zenbot/master?t=moon)
- **3.2.4**
...
### Can I use Zenbot 3 with [X] exchange?
...
### What does [trader] not enough funds mean?

It means the bot tried to buy or sell, but had not enough asset or currency balance to do that. If you feel comfortable investing, you can deposit asset or currency in your account and Zenbot will use that the next time the trade signal triggers.
...
`1KmiXwipn8izr2HfNVL1n7as3wAkaKFPTq`

![zenbot logo](https://s8f.org/files/bitcoin.png)

thanks!

## Simulator Demo (3.5.13)
