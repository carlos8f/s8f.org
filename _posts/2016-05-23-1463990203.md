...
- 1982 - RSA developers found RSA Data Security in 1982 as a private company.
...
- 1997 - Adam L. Young and Moti Yung present a "cryptovirology" papar on building backdoors into asymmetric algorithms.
...
- 2006 - RSA Security, Inc. acquired by EMC Corporation in for $2.1 billion.
...
- 2013 - RSA Security discontinues using Dual_EC_DRBG, after Edward Snowden reveals that RSA was paid $10 million by NSA to use Dual_EC_DRBG.
...
- May 2013 - [Edward Snowden](https://en.wikipedia.org/wiki/Global_surveillance_disclosures_(2013%E2%80%93present)) goes on temp. leave from his position at NSA, citing the pretext of receiving treatment for his epilepsy. He later travels to Hong Kong and revealed he used PGP, tor, and other popular crypto programs to exfiltrate huge amounts of US secrets to the press. Although he settled in Russia after that, he claims he [http://www.huffingtonpost.com/bob-cesca/edward-snowden-bizarre-interview_b_5421572.html]("destroyed his documents") before going to Russia.
- August 8, 2013 - Lavabit shut down by US mandate.
- August 9, 2013 - Silent Circle shut down by US pressure.
- May 2014 - 12-minute video guide "GPG for Journalists" posted to Vimeo in January 2013 by a user named anon108. The Washington Post later identified anon108 as fugitive NSA whistleblower Edward Snowden.
...
- April 1st, 2014 - A "catastrophic" OpenSSL vulnerability (and possible back-door) "[Heartbleed](https://en.wikipedia.org/wiki/Heartbleed)" revealed by Google. At the time of disclosure, some 17% (around half a million) of the Internet's secure web servers certified by trusted authorities were believed to be vulnerable to the attack.
...
- June 4th, 2014: [Google announces end-to-end encryption for Gmail (a big deal!)](http://boingboing.net/2014/06/04/google-announces-end-to-end-en.html)
